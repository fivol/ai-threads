...
export function IconPin({ filled = false }: { filled?: boolean }) {
  return (
    <svg viewBox="0 0 24 24" fill={filled ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M16 3l5 5-4 4v5l-2 2-4-4-6 6-2-2 6-6-4-4 2-2h5l4-4z" />
    </svg>
  );
}
...
export function IconBrain() {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
      <path d="M12 2a5 5 0 00-5 5c0 .88.23 1.71.64 2.43A5.002 5.002 0 0012 17a5.002 5.002 0 004.36-7.57c.41-.72.64-1.55.64-2.43a5 5 0 00-5-5z" />
